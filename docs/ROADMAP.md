...
- Keep Europe PMC default-off while the completed synthetic mechanics gate is followed by a bounded isolated-provider/raw-candidate evaluator, a disjoint independently authored holdout, and multiple time-separated, reviewed live diagnostics for the intended audience.
